...
#### COMMON MISTAKES TO AVOID WITH CSS POINT THREE

### Course Step Number: 456
...
#### SUBSECTION F: BOOTSTRAP PART 2

### Course Step Number: 514

### Date Researched: 2025-08-14

##### Key Concepts / Summary

This entry documents a structural step in the course, introducing the student to the next phase of the Bootstrap tutorial series. It provides an organizational overview of the upcoming lessons, which include learning about data attributes, a video tutorial, and two quizzes.
...
#### SUBSECTION G: BOOTSTRAP PART 3

### Course Step Number: 520

### Date Researched: 2025-08-14

##### Key Concepts / Summary

This entry documents a structural step in the course, introducing the student to the next phase of the Bootstrap tutorial series. It provides an organizational overview of the upcoming lessons, which include learning about Data URLs, SVG, and XML Namespaces, followed by two quizzes and another video tutorial.
...
#### SUBSECTION H: BOOTSTRAP PART 4

### Course Step Number: 527
...
### Course Step Number: 529

### Date Researched: 2025-08-14

##### Key Concepts / Summary

This entry documents the completion of a quiz on core concepts from the previous lessons. The student demonstrated an understanding of the Bootstrap `py-3` class, which provides padding only on the vertical axis, and the CSS `background-color` property.
...
#### QUIZ - Bootstrap Core Concepts

### Course Step Number: 532

### Date Researched: 2025-08-17

##### Key Concepts / Summary

This quiz covered several fundamental Bootstrap concepts. The `d-flex` class is used to create a flex container, enabling powerful alignment and distribution of elements. The `m-0` class is part of the spacing utility API, and it specifically removes the default margins from an element. Finally, a responsive grid is created by using the combination of `.row` and `.col` classes to define columns and their parent rows.

##### Independent Research / Notable Discoveries

**Best Practices**: Bootstrap's utility classes like `d-flex` and `m-0` are the preferred method for quick styling and layout manipulation as they provide a clear, semantic way to apply styles without writing custom CSS.
**Modernization**: Modern versions of Bootstrap are built on a flexbox foundation, making classes like `d-flex` central to the framework's layout system.
**Enhanced Learning (UX Bias)**: Proper use of Bootstrap's grid and spacing classes is critical for creating a clean, professional, and readable layout that provides an excellent user experience.
...
#### QUIZ - validating video lesson knowledge

### Course Step Number: 577

### Date Researched: 2025-08-25

##### Key Concepts / Summary

This quiz validated the understanding of two key concepts from the preceding video lesson: the role of the `public_ftp` folder and the purpose of "FTP over TLS" in providing a secure connection.
